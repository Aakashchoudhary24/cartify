              ...
              {activeSection === 'address' && (
                <div className="bg-[#DCD6F7] rounded-xl overflow-hidden shadow-lg">
                  ...
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-[#424874] mb-1">Country</label>
                        {isEditing ? (
                          <input
                            type="text"
                            name="country"
                          ...
                          <p className="text-[#424874]">{profile.country}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[#424874] mb-1">City/State</label>
                        {isEditing ? (
                          <input
                            type="text"
                            name="city"
                          ...
                          <p className="text-[#424874]">{profile.city}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[#424874] mb-1">Street/Door No.</label>
                        {isEditing ? (
                          <input
                            type="text"
                            name="street"
                          ...
                          <p className="text-[#424874]">{profile.street}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[#424874] mb-1">Near by</label>
                        {isEditing ? (
                          <input
                            type="text"
                            name="nearby"
                          ...
                          <p className="text-[#424874]">{profile.nearby}</p>
                        )}
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-[#424874] mb-1">Pincode</label>
                        {isEditing ? (
                          <input
                            type="text"
                            name="pincode"
                          ...
                          <p className="text-[#424874]">{profile.pincode}</p>
                        )}
                      </div>
                    </div>
                  </div>
